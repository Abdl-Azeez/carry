...
! function(t) {
    ...
    return o.widget("ui.spinner", {
        ...
        _adjustValue: function(t) {
            var i, e, n = this.options;
            return e = t - (i = null !== n.min ? n.min : 0), t = i + (e = Math.round(e / n.step) * n.step), t = parseFloat(t.toFixed(this._precision())), null !== n.max && t > n.max ? n.max : null !== n.min && t < n.min ? n.min : t
        },
        _stop: function(t) {
