...
if (typeof GETCAB_STORAGE == 'undefined') var GETCAB_STORAGE = {};

function getcab_storage_get(var_name) {
    "use strict";
    return getcab_isset(GETCAB_STORAGE[var_name]) ? GETCAB_STORAGE[var_name] : '';
}

function getcab_storage_set(var_name, value) {
    "use strict";
    GETCAB_STORAGE[var_name] = value;
}

function getcab_storage_inc(var_name) {
    "use strict";
    var value = arguments[1] == undefined ? 1 : arguments[1];
    GETCAB_STORAGE[var_name] += value;
}

function getcab_storage_concat(var_name, value) {
    "use strict";
    GETCAB_STORAGE[var_name] += '' + value;
}

function getcab_storage_get_array(var_name, key) {
    "use strict";
    return getcab_isset(GETCAB_STORAGE[var_name][key]) ? GETCAB_STORAGE[var_name][key] : '';
}

function getcab_storage_set_array(var_name, key, value) {
    "use strict";
    if (!getcab_isset(GETCAB_STORAGE[var_name])) GETCAB_STORAGE[var_name] = {};
    GETCAB_STORAGE[var_name][key] = value;
}

function getcab_storage_inc_array(var_name, key) {
    "use strict";
    var value = arguments[2] == undefined ? 1 : arguments[2];
    GETCAB_STORAGE[var_name][key] += value;
}

function getcab_storage_concat_array(var_name, key, value) {
    "use strict";
    GETCAB_STORAGE[var_name][key] += '' + value;
}

function getcab_isset(obj) {
    "use strict";
    return typeof(obj) != 'undefined';
}

function getcab_empty(obj) {
    "use strict";
    return typeof(obj) == 'undefined' || (typeof(obj) == 'object' && obj == null) || (typeof(obj) == 'array' && obj.length == 0) || (typeof(obj) == 'string' && getcab_alltrim(obj) == '') || obj === 0;
}

function getcab_is_array(obj) {
    "use strict";
    return typeof(obj) == 'array';
}

function getcab_is_object(obj) {
    "use strict";
    return typeof(obj) == 'object';
}

function getcab_clone_object(obj) {
    "use strict";
    ...
    var temp = {};
    for (var key in obj) {
        temp[key] = getcab_clone_object(obj[key]);
    }
    return temp;
}

function getcab_merge_objects(obj1, obj2) {
    "use strict";
    for (var i in obj2) obj1[i] = obj2[i];
    return obj1;
}

function getcab_serialize(mixed_val) {
    "use strict";
        ...
        case "object":
            if (mixed_val == null) return "N;";
                ...
                for (var i = 0; i < mixed_val.length; i++) {
                    idxobj.idx++;
                    var ser = getcab_serialize(mixed_val[i]);
                    if (ser) map.push(getcab_serialize(idxobj.idx) + ser);
                }
                return "a:" + mixed_val.length + ":{" + map.join("") + "}";
            } else {
                var class_name = getcab_get_class(mixed_val);
                if (class_name == undefined) return false;
                var props = new Array();
                for (var prop in mixed_val) {
                    var ser = getcab_serialize(mixed_val[prop]);
                    if (ser) props.push(getcab_serialize(prop) + ser);
                }
...
function getcab_in_list(str, list) {
    "use strict";
...
function getcab_ltrim(str) {
    "use strict";
    return getcab_alltrim(str, 'l');
}

function getcab_rtrim(str) {
    "use strict";
    return getcab_alltrim(str, 'r');
}

function getcab_padl(str, len) {
    "use strict";
...
function getcab_replicate(str, num) {
    "use strict";
    var rez = '';
    for (var i = 0; i < num; i++) {
        rez += str;
...
function getcab_clear_number(num) {
    "use strict";
    var precision = arguments[1] ? arguments[1] : 0;
...
function getcab_dec2hex(n) {
    "use strict";
    return Number(n).toString(16);
}

function getcab_hex2dec(hex) {
    "use strict";
    return parseInt(hex, 16);
}

function getcab_in_array(val, thearray) {
    "use strict";
    var rez = false;
...
function getcab_sort_array(thearray) {
    "use strict";
...
function getcab_get_date_difference(dt1) {
    "use strict";
    var dt2 = arguments[1] !== undefined ? arguments[1] : '';
    var short_date = arguments[2] !== undefined ? arguments[2] : true;
    var sec = arguments[3] !== undefined ? arguments[3] : false;
    var a1 = getcab_parse_date(dt1);
    dt1 = Date.UTC(a1[0], a1[1], a1[2], a1[3], a1[4], a1[5]);
    if (dt2 == '') {
        dt2 = new Date();
        var a2 = [dt2.getFullYear(), dt2.getMonth() + 1, dt2.getDate(), dt2.getHours(), dt2.getMinutes(), dt2.getSeconds()];
    } else var a2 = getcab_parse_date(dt2);
...
function getcab_components2hex(r, g, b) {
    "use strict";
...
function getcab_rgb2components(color) {
    "use strict";
    color = getcab_rgb2hex(color);
...
function getcab_hex2hsb(hex) {
    "use strict";
    return getcab_rgb2hsb(getcab_hex2rgb(hex));
}

function getcab_hsb2hex(hsb) {
    "use strict";
    var rgb = getcab_hsb2rgb(hsb);
    return getcab_components2hex(rgb.r, rgb.g, rgb.b);
}

function getcab_rgb2hsb(rgb) {
    "use strict";
    var hsb = {};
...
function getcab_color_picker() {
    ...
    jQuery(document.createElement("div")).attr("id", id).css('display', 'none').html(tbl).appendTo("body").addClass("iColorPickerTable").on('mouseover', 'thead td', function() {
        "use strict";
        var aaa = getcab_rgb2hex(jQuery(this).css('background-color'));
        ...
        if (thead.hasClass('more_colors')) {
            ...
            while (rgb[0] < 0xF || rgb[1] < 0xF || rgb[2] < 0xF) {
                ...
                i++;
                out += '<td style="background-color:' + getcab_components2hex(rgb[0] * 16 + rgb[0], rgb[1] * 16 + rgb[1], rgb[2] * 16 + rgb[2]) + '">&nbsp;</td>';
                rgb[2] += 3;
                if (rgb[2] > 0xF) {
                    rgb[1] += 3;
                    if (rgb[1] > (j === 0 ? 6 : 0xF)) {
...
function getcab_color_picker_show(id, fld, func) {
    "use strict";
    if (id === null || id === '') {
    ...
    var def = fld.val().substr(0, 1) == '#' ? fld.val() : getcab_rgb2hex(fld.css('backgroundColor'));
    jQuery('#' + id + '_colorPreview input,#' + id + '_colorOriginal input').val(def);
    jQuery('#' + id + '_colorPreview,#' + id + '_colorOriginal').css('background', def);
}

function getcab_get_cookie(name) {
    "use strict";
...
function getcab_set_cookie(name, value, expires, path, domain, secure) {
    "use strict";
...
function getcab_del_cookie(name, path, domain) {
    "use strict";
    var path = arguments[1] != undefined ? arguments[1] : '/';
    var domain = arguments[2] != undefined ? arguments[2] : '';
    if (getcab_get_cookie(name)) document.cookie = name + '=' + ((path) ? ';path=' + path : '') + ((domain) ? ';domain=' + domain : '') + ';expires=Thu, 01-Jan-1970 00:00:01 GMT';
}

function getcab_clear_listbox(box) {
    "use strict";
    for (var i = box.options.length - 1; i >= 0; i--) box.options[i] = null;
}

function getcab_add_listbox_item(box, val, text) {
    "use strict";
    var item = new Option();
    item.value = val;
    item.text = text;
...
function getcab_del_listbox_item_by_value(box, val) {
    "use strict";
...
function getcab_del_listbox_item_by_text(box, txt) {
    "use strict";
    for (var i = 0; i < box.options.length; i++) {
...
function getcab_find_listbox_item_by_value(box, val) {
    "use strict";
    var idx = -1;
    for (var i = 0; i < box.options.length; i++) {
        if (box.options[i].value == val) {
...
function getcab_find_listbox_item_by_text(box, txt) {
    "use strict";
    var idx = -1;
    for (var i = 0; i < box.options.length; i++) {
        if (box.options[i].text == txt) {
...
function getcab_select_listbox_item_by_value(box, val) {
    "use strict";
    for (var i = 0; i < box.options.length; i++) {
...
function getcab_select_listbox_item_by_text(box, txt) {
    "use strict";
    for (var i = 0; i < box.options.length; i++) {
...
function getcab_get_listbox_values(box) {
    "use strict";
...
function getcab_get_listbox_texts(box) {
    "use strict";
    var delim = arguments[1] ? arguments[1] : ',';
    var str = '';
    for (var i = 0; i < box.options.length; i++) {
...
function getcab_sort_listbox(box) {
    "use strict";
...
function getcab_get_listbox_selected_index(box) {
    "use strict";
    for (var i = 0; i < box.options.length; i++) {
...
function getcab_get_listbox_selected_value(box) {
    "use strict";
    for (var i = 0; i < box.options.length; i++) {
...
function getcab_get_listbox_selected_text(box) {
    "use strict";
    for (var i = 0; i < box.options.length; i++) {
        if (box.options[i].selected) {
...
function getcab_get_listbox_selected_option(box) {
    "use strict";
    for (var i = 0; i < box.options.length; i++) {
        if (box.options[i].selected) {
...
function getcab_get_radio_value(radioGroupObj) {
    "use strict";
...
function getcab_set_radio_checked_by_num(radioGroupObj, num) {
    "use strict";
    for (var i = 0; i < radioGroupObj.length; i++)
...
function getcab_set_radio_checked_by_value(radioGroupObj, val) {
    "use strict";
    for (var i = 0; i < radioGroupObj.length; i++)
...
function getcab_form_validate(form, opt) {
    "use strict";
    var error_msg = '';
...
function getcab_document_animate_to(id, callback) {
    "use strict";
...
function getcab_document_set_location(curLoc) {
    "use strict";
    try {
...
function getcab_add_to_url(prm) {
    "use strict";
...
function getcab_browser_is_mobile() {
    "use strict";
    var check = false;
    (function(a) {
...
function getcab_browser_is_ios() {
    "use strict";
    return navigator.userAgent.match(/iPad|iPhone|iPod/i) != null;
}

function getcab_is_retina() {
    "use strict";
    var mediaQuery = '(-webkit-min-device-pixel-ratio: 1.5), (min--moz-device-pixel-ratio: 1.5), (-o-min-device-pixel-ratio: 3/2), (min-resolution: 1.5dppx)';
    return (window.devicePixelRatio > 1) || (window.matchMedia && window.matchMedia(mediaQuery).matches);
}

function getcab_get_file_name(path) {
    "use strict";
    path = path.replace(/\\/g, '/');
...
function getcab_get_file_ext(path) {
    "use strict";
    var pos = path.lastIndexOf('.');
...
function getcab_check_images_complete(cont) {
    "use strict";
    var complete = true;
...
function getcab_debug_object(obj) {
    "use strict";
    ...
    if (obj !== null) {
        ...
        for (var prop in obj) {
            ...
            try {
                ...
                if (recursive && level <= 3 && (typeof(obj[prop]) == 'object' || typeof(obj[prop]) == 'array') && obj[prop] != obj) dispStr += addStr + (html ? "<b>" : "") + prop + (html ? "</b>" : "") + '=' + getcab_debug_object(obj[prop], html, recursive, showMethods, level + 1);
...
function getcab_debug_log(s) {
    "use strict";
    if (GETCAB_STORAGE['user_logged_in']) {
...
function dco(s, r) {
    console.log(getcab_debug_object(s, false, r));
}
if (window.dal === undefined)
function dal(s) {
    if (GETCAB_STORAGE['user_logged_in']) alert(s);
}
if (window.dao === undefined)
function dao(s, r) {
    if (GETCAB_STORAGE['user_logged_in']) alert(getcab_debug_object(s, false, r));
}
...
function ddo(s, r) {
    getcab_debug_log(getcab_debug_object(s, true, r));
}
jQuery(document).ready(function() {
    "use strict";
...
function getcab_ready_actions() {
    ...
    if (document.documentElement.className.indexOf(GETCAB_STORAGE['site_scheme']) == -1) document.documentElement.className += ' ' + GETCAB_STORAGE['site_scheme'];
    ...
    GETCAB_STORAGE['top_panel_height'] = 0;
                            ...
                            ajax_timer = setTimeout(function() {
                                jQuery.post(GETCAB_STORAGE['ajax_url'], {
                                    ...
                                    try {
                                        ...
                                        rez = {
                                            error: GETCAB_STORAGE['search_error']
                                        };
    ...
    if (jQuery('.woocommerce div.quantity .q_inc,.woocommerce-page div.quantity .q_inc').length == 0) {
        ...
        jQuery('.woocommerce div.quantity,.woocommerce-page div.quantity').on('click', '>span', function(e) {
            cars4rent_woocomerce_inc_dec_click(jQuery(this));
            e.preventDefault();
            return false;
        });
    }
    ...
    function cars4rent_woocomerce_inc_dec_click(button) {
    ...
    jQuery('.nav-links-more a').on('click', function(e) {
        ...
        if (panel.length == 0) {
            jQuery.get(location.href, {
                ...
                "use strict";
                var p1 = response.indexOf('getcab-inline-styles-inline-css');
                if (p1 > 0) {
                    p1 = response.indexOf('>', p1) + 1;
                    var p2 = response.indexOf('</style>', p1);
                    var inline_css_add = response.substring(p1, p2);
                    var inline_css = jQuery('#getcab-inline-styles-inline-css');
                    if (inline_css.length == 0) jQuery('body').append('<style id="getcab-inline-styles-inline-css" type="text/css">' + inline_css_add + '</style>');
            ...
            jQuery.post(GETCAB_STORAGE['ajax_url'], {
                ...
                try {
                    ...
                    rez = {
                        error: GETCAB_STORAGE['strings']['ajax_error']
                    };
                    console.log(response);
                }
                if (rez.error !== '') {
        ...
        function getcab_loadmore_add_items(container, items) {
            ...
            else GETCAB_STORAGE['load_more_link_busy'] = false;
    ...
    if (GETCAB_STORAGE['use_mediaelements'] && cont.find('audio:not(.inited),video:not(.inited)').length > 0) {
        if (window.mejs) {
            ...
            cont.find('audio:not(.inited),video:not(.inited)').each(function() {
                "use strict";
                if (jQuery(this).parents('.mejs-mediaelement').length == 0 && jQuery(this).parents('.wp-block-video').length == 0 && !jQuery(this).hasClass('wp-block-cover__video-background') && (GETCAB_STORAGE['init_all_mediaelements'] || (!jQuery(this).hasClass('wp-audio-shortcode') && !jQuery(this).hasClass('wp-video-shortcode') && !jQuery(this).parent().hasClass('wp-playlist')))) {
...
function getcab_tabs_ajax_content_loader(panel, page, oldPanel) {
    ...
    } else panel.find('> *').addClass('getcab_tab_content_remove');
...
function getcab_comments_validate(form) {
    ...
    var comments_args = {
        error_message_text: GETCAB_STORAGE['strings']['error_global'],
        error_message_show: true,
        error_message_time: 4000,
        error_message_class: 'getcab_messagebox getcab_messagebox_style_error',
        ...
        rules: [{
            ...
            min_length: {
                value: 1,
                message: GETCAB_STORAGE['strings']['text_empty']
            },
            max_length: {
                value: GETCAB_STORAGE['message_maxlength'],
                message: GETCAB_STORAGE['strings']['text_long']
            }
        }]
    };
    if (form.find('.comments_author input[aria-required="true"]').length > 0) {
        comments_args.rules.push({
            ...
            min_length: {
                value: 1,
                message: GETCAB_STORAGE['strings']['name_empty']
            },
            max_length: {
                value: 60,
                message: GETCAB_STORAGE['strings']['name_long']
            }
        });
    }
    if (form.find('.comments_email input[aria-required="true"]').length > 0) {
        comments_args.rules.push({
            ...
            min_length: {
                value: 1,
                message: GETCAB_STORAGE['strings']['email_empty']
            },
            max_length: {
                value: 60,
                message: GETCAB_STORAGE['strings']['email_long']
            },
            mask: {
                value: GETCAB_STORAGE['email_mask'],
                message: GETCAB_STORAGE['strings']['email_not_valid']
            }
        });
    }
...
'use strict';
jQuery('.copyright_text a').each(function() {
...
jQuery(document).on('action.ready', function(e) {
    if (GETCAB_STORAGE['menu_hover'] == 'slide_line' || GETCAB_STORAGE['menu_hover'] == 'slide_box') {
        setTimeout(function() {
            "use strict";
            jQuery('#menu_main').spasticNav({
                style: GETCAB_STORAGE['menu_hover'] == 'slide_line' ? 'line' : 'box',
                color: GETCAB_STORAGE['menu_hover_color'],
                colorOverride: false
            });
        }, 500);
    }
...
jQuery(document).on('action.init_hidden_elements', function(e, cont) {
    if (GETCAB_STORAGE['button_hover'] && GETCAB_STORAGE['button_hover'] != 'default') {
        ...
        jQuery('.trx_addons_hover_content .trx_addons_hover_links a:not([class*="sc_button_hover_style_"])\ ').addClass('sc_button_hover_style_inverse');
        ...
        jQuery('.sidebar .trx_addons_tabs .trx_addons_tabs_titles li a:not([class*="sc_button_hover_style_"]),\ .getcab_tabs .getcab_tabs_titles li a:not([class*="sc_button_hover_style_"]),\ .widget_tag_cloud a:not([class*="sc_button_hover_style_"]),\ .widget_product_tag_cloud a:not([class*="sc_button_hover_style_"])\ ').addClass('sc_button_hover_style_alterbd');
        ...
        jQuery('.mejs-controls button,\ .mfp-close,\ .widget_contacts .social_icons\ ').removeClass('sc_button_hover_' + GETCAB_STORAGE['button_hover']);
    }
});
...
function getcab_trx_addons_add_googlemap_styles(e) {
    ...
    TRX_ADDONS_STORAGE['googlemap_styles']['greyscale'] = [{
        "featureType": "administrative",
        "elementType": "all",
        "stylers": [{
            "visibility": "off"
